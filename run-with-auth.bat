...
echo Step 2: Starting local backend with auth...
echo Opening new terminal window...
start "Backend with Auth" cmd /k ".venv\Scripts\python.exe -m uvicorn api.main:app --host 0.0.0.0 --port 5055 --reload"
...
echo ========================================
echo Services Started with Auth!
echo ========================================
echo.
